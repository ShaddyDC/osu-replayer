...
public:
    ...
    [[nodiscard]] std::vector<Circle_object*> circles_at(std::chrono::milliseconds time, const Beatmap_info_provider& info_provider);
    [[nodiscard]] std::vector<Slider_object*> sliders_at(std::chrono::milliseconds time, const Beatmap_info_provider& info_provider);
