...
class Visible_hitobjects_manager {
public:
    Visible_hitobjects_manager(const Beatmap_manager& beatmap, const Replay_manager& replay, const Playfield_coordinate_provider& coordinate_provider, const Playback_logic& player);
...
private:
    ...
    void draw_circle(Circle_object& circle, const Beatmap_info_provider& info_provider);
    void draw_slider(Slider_object& slider, const Beatmap_info_provider& info_provider);
