...
Magnum::Vector2i Playfield_size_manager::get_size()
{
    return scaling_size;
}
Magnum::Vector2i Playfield_size_manager::get_top_left()
{
    return top_left;
}
Magnum::Vector2i Playfield_size_manager::get_bottom_right()
{
    return bottom_right;
}
